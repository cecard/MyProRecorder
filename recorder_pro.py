...
class ProfessionalRecorder:
    def __init__(self, root):
        ...
        self.root.geometry("500x420") # 稍微调高一点以容纳新开关
    ...
    def setup_ui(self):
        ...
        # --- 新增：鼠标录制开关 Checkbutton ---
        # 使用 selectcolor 调整勾选框背景色，fg 调整文字颜色
        chk_cursor = tk.Checkbutton(self.root, text="录制鼠标光标", variable=self.record_cursor_var, 
